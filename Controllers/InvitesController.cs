...
namespace BugTracker.Controllers
{
    public class InvitesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,InviteDate,JoinDate,CompanyToken,InviteeEmail,InviteeFirstName,InviteeLastName,Message,IsValid,CompanyId,ProjectId,InviteeId,InvitorId")] Invite invite)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,InviteDate,JoinDate,CompanyToken,InviteeEmail,InviteeFirstName,InviteeLastName,Message,IsValid,CompanyId,ProjectId,InviteeId,InvitorId")] Invite invite)
        {
            if (id != invite.Id)
            {
                return NotFound();
